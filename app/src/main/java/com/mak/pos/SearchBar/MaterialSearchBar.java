...
public class MaterialSearchBar extends RelativeLayout implements View.OnClickListener,
    ...
    private TextView tventerboopsid;
    ...
    private void init(AttributeSet attrs) {
        ...
        arrowIcon = (TextView) findViewById(R.id.mt_arrow);
        arrowIcon.setEnabled(true);
        tventerboopsid = (TextView) findViewById(R.id.tventerboopsid);
    ...
    public void disableSearch() {
        try {
            ...
            tventerboopsid.setVisibility(VISIBLE);

            inputContainer.startAnimation(out);
            searchIcon.startAnimation(in);
           // MainActivity.rlSearch.setVisibility(GONE);
            tventerboopsid.startAnimation(in);
    ...
    public void enableSearch() {
        try {
            ...
            // searchEdit.setHint("Enter Boops Id");
            // searchEdit.setHintTextColor(Color.parseColor("#000000"));
            //searchEdit.setTextSize(13);
            tventerboopsid.startAnimation(left_out);
    ...
    public void onClick(View v) {
        ...
        if (id == getId()) {
           ...
           /* else
            ...
            findViewById(R.id.mt_clear).setVisibility(GONE);
    ...
    public void onAnimationEnd(Animation animation) {
        if (!searchEnabled) {
            ...
            tventerboopsid.setVisibility(GONE);
